 ...
 * PostgreSQL.
 */
public class ModifyPostgreSQLSource {
    ...
    /** Builder class of {@link ModifyPostgreSQLSource}. */
    public static class Builder<T> {
        ...
        public ModifyDebeziumSourceFunction<T> build() {
            ...
            return new ModifyDebeziumSourceFunction<>(
