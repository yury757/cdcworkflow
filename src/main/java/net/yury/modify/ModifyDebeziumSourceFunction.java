...
/**
 * The {@link ModifyDebeziumSourceFunction} is a streaming data source that pulls captured change data
 ...
 */
@PublicEvolving
public class ModifyDebeziumSourceFunction<T> extends RichSourceFunction<T>
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(ModifyDebeziumSourceFunction.class);
    ...
    public ModifyDebeziumSourceFunction(
    ...
    public void run(SourceContext<T> sourceContext) throws Exception {
        ...
        properties.setProperty("offset.storage", ModifyFlinkOffsetBackingStore.class.getCanonicalName());
        if (restoredOffsetState != null) {
            // restored from state
            properties.setProperty(ModifyFlinkOffsetBackingStore.OFFSET_STATE_VALUE, restoredOffsetState);
        }
